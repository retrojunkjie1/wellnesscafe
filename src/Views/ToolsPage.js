...
const ToolsPage = () => {
  ...
  const breathingPresets = [
    ...
    },
    {
      ...
      benefits: ['Improves concentration', 'Reduces mental fog', 'Enhances decision-making']
    },
    {
      id: 'sleep',
      ...
      benefits: ['Promotes relaxation', 'Reduces racing thoughts', 'Prepares body for sleep']
    },
    {
      id: 'energy',
      name: 'Energy Boost',
      ...
      benefits: ['Increases alertness', 'Balances nervous system', 'Improves mood']
    }
  ];
  ...
  const breathingTechniques = [
    {
      name: 'Box Breathing',
      pattern: '4-4-4-4',
      description: 'Equal parts inhale, hold, exhale, and pause. Used by military and first responders.',
      bestFor: 'Stress management, mental clarity, pre-performance'
    },
    {
      name: '4-7-8 Breathing',
      pattern: '4-7-8',
      description: 'Natural tranquilizer for the nervous system. Exhale is twice as long as inhale.',
      bestFor: 'Insomnia, anxiety, anger management'
    },
    {
      name: 'Resonant Breathing',
      pattern: '5-0-5',
      description: 'Breathe at 5-6 breaths per minute. Maximizes heart rate variability.',
      bestFor: 'Overall wellness, emotional regulation, cardiovascular health'
    },
    {
      name: 'Pursed Lip Breathing',
      pattern: '2-0-4',
      description: 'Slow, controlled breathing through pursed lips. Keeps airways open longer.',
  ...
  const comingSoonTools = [
    {
      ...
      eta: 'Coming Q1 2025',
      features: ['Visual timeline', 'Pattern analysis', 'Coping suggestions', 'Export reports']
    },
    {
      id: 'cravings',
      name: 'Urge Surfing',
      icon: '🌊',
      description: 'Navigate cravings with guided meditation and distraction techniques',
      eta: 'Coming Q1 2025',
      features: ['Guided meditation', 'Timer & tracking', 'Success strategies', 'Community support']
    },
    {
      id: 'intentions',
      name: 'Daily Intentions',
      icon: '🌅',
      description: 'Set meaningful goals with affirmations and progress tracking',
      eta: 'Coming Q2 2025',
      features: ['Morning prompts', 'Affirmations library', 'Habit tracking', 'Reflection journal']
    },
    {
      id: 'gratitude',
      ...
      eta: 'Coming Q2 2025',
      features: ['Daily prompts', 'Photo attachments', 'Mood insights', 'Streak tracking']
    },
    {
      id: 'sleep',
      name: 'Sleep Hygiene',
      ...
      eta: 'Coming Q2 2025',
      features: ['Sleep tracking', 'Wind-down rituals', 'Dream journal', 'Quality insights']
    },
    {
      id: 'check-in',
      name: 'Quick Check-In',
      ...
      eta: 'In Development',
      features: ['30-second check-ins', 'Trend visualization', 'Weekly summaries', 'Intervention alerts']
    }
  ];
      ...
      <main className="container">
        ...
        <div className="tools-hero">
          <div className="tools-hero-content">
            ...
            <p className="hero-subtitle">
              Evidence-based tools to support your daily wellness journey. 
              Track progress, manage triggers, and build healthy habits—all in one place.
            </p>
        ...
        <section className="section why-tools">
          <div className="section-header-center">
            ...
            <p>Science-backed techniques proven to support recovery and mental wellness</p>
          </div>
          <div className="benefits-grid">
            <div className="benefit-card">
              <div className="benefit-icon">🧠</div>
              <h3>Evidence-Based</h3>
              <p>Built on research from neuroscience, psychology, and addiction medicine</p>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon">📱</div>
              <h3>Always Accessible</h3>
              <p>Available 24/7 whenever you need support, no appointments necessary</p>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon">🔒</div>
              <h3>Private & Secure</h3>
              <p>Your data is encrypted and never shared. Complete privacy guaranteed</p>
            </div>
            <div className="benefit-card">
              <div className="benefit-icon">📈</div>
              <h3>Track Progress</h3>
              <p>See your growth over time with detailed analytics and insights</p>
            </div>
          </div>
        </section>
        ...
        <section className="section techniques-guide">
          ...
          <div className="presets-grid">
            {breathingPresets.map((preset) => (
              ...
              >
                ...
                <h3>{preset.name}</h3>
                <div className="preset-pattern">{preset.inhale}-{preset.hold}-{preset.exhale}</div>
          ...
          <div className="techniques-expandable">
            ...
            >
              {showTechniques ? '▼' : '▶'} Learn About Different Breathing Techniques
            </button>
            {showTechniques && (
                ...
                {breathingTechniques.map((technique, i) => (
                  <div key={i} className="technique-item">
                    <div className="technique-header">
                      ...
                      <span className="technique-pattern">{technique.pattern}</span>
                    </div>
          ...
          <div className="testimonials-grid">
            <div className="testimonial-card">
              ...
              <p className="testimonial-text">
                "The breathing tool has become my go-to during moments of anxiety. 
                The voice guidance keeps me focused, and I can see my progress over time."
              </p>
              <div className="testimonial-author">— Anonymous User, 6 months sober</div>
            </div>
            <div className="testimonial-card">
              <div className="testimonial-rating">★★★★★</div>
              <p className="testimonial-text">
                "I use the 4-7-8 pattern every night before bed. My sleep has improved 
                dramatically, and I wake up feeling more rested."
              </p>
              <div className="testimonial-author">— Anonymous User, 1 year sober</div>
            </div>
            <div className="testimonial-card">
              <div className="testimonial-rating">★★★★★</div>
              <p className="testimonial-text">
                "Having these tools available 24/7 gives me confidence. I know I always 
                have something to turn to when I'm struggling."
              </p>
              <div className="testimonial-author">— Anonymous User, 90 days sober</div>
            </div>
          </div>
        </section>
        ...
        <section className="section professional-resources">
          <div className="resources-content">
            ...
            <p>These tools complement professional treatment. If you're in crisis or need immediate help:</p>
            <div className="crisis-resources">
              <div className="resource-item">
                <h3>988 Suicide & Crisis Lifeline</h3>
                <a href="tel:988" className="resource-link">Call or Text 988</a>
                <p>24/7 confidential support for people in distress</p>
              </div>
              <div className="resource-item">
                <h3>SAMHSA National Helpline</h3>
                <a href="tel:1-800-662-4357" className="resource-link">1-800-662-HELP (4357)</a>
        ...
        <section className="section additional-links">
          <div className="links-grid">
            <Link className="link-card" to="/trauma-education">
              ...
              <p>Learn about trauma, the nervous system, and healing practices</p>

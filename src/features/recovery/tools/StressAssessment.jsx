...
const StressAssessment = () => {
  ...
  const getStressLevel = (score) => {
    if (score <= 13) return { level: 'Low', color: '#4db8a8', description: 'You appear to be managing stress well.' };
    if (score <= 26) return { level: 'Moderate', color: '#f4a261', description: 'You are experiencing moderate stress levels.' };
    return { level: 'High', color: '#e63946', description: 'You are experiencing high stress that may benefit from intervention.' };
  };
  ...
  const progressPercentage = (Object.keys(answers).length / PSS10_QUESTIONS.length) * 100;
    ...
    return (
      <div className="stress-assessment">
        <Helmet>
          ...
          <meta name="description" content="Review your PSS-10 stress assessment results and personalized recommendations." />
        </Helmet>

        <div className="results-container">
          <div className="results-header">
            <ClipboardCheck className="results-icon" style={{ color: stressData.color }} />
            <h1>Your Stress Assessment Results</h1>
            <p>Based on the Perceived Stress Scale (PSS-10)</p>
          </div>

          <div className="score-display" style={{ borderColor: stressData.color }}>
            <div className="score-number" style={{ color: stressData.color }}>
              {score}
              <span className="score-total">/40</span>
            </div>
            <div className="stress-level" style={{ background: `linear-gradient(135deg, ${stressData.color}, ${stressData.color}dd)` }}>
          ...
          <div className="stress-breakdown">
            ...
            <div className="score-ranges">
              ...
              <div className={`range-item ${score > 13 && score <= 26 ? 'active' : ''}`}>
          ...
          <div className="cta-section">
            <div className="premium-upsell">
              ...
              <p>Premium members can save assessments, track progress, and receive personalized insights.</p>
              <button className="upgrade-btn">Upgrade to Premium - $9.99/mo</button>
            </div>
          ...
          <div className="disclaimer">
            ...
            <p>
              ...
              If you're experiencing significant distress, please consult a mental health professional.
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="stress-assessment">
      <Helmet>
        ...
        <meta name="description" content="Take the scientifically-validated PSS-10 stress assessment to understand your stress levels." />
      </Helmet>

      <div className="assessment-header">
        <ClipboardCheck className="header-icon" />
        <h1>Stress Level Assessment</h1>
        <p>Complete this 10-question survey to understand your current stress level</p>
      ...
      <div className="progress-bar-container">
        ...
        <p className="progress-text">
          {Object.keys(answers).length} of {PSS10_QUESTIONS.length} questions answered
        </p>
      </div>
          ...
          <div key={question.id} className="question-card">
            ...
            <div className="likert-scale">
              {LIKERT_OPTIONS.map(option => (
                <label 
                  key={option.value} 
                  className={`likert-option ${answers[question.id] === option.value ? 'selected' : ''}`}
                >
                  <input
                    type="radio"
      ...
      <div className="assessment-info">
        ...
        <p>
          The Perceived Stress Scale (PSS-10) is the most widely used psychological instrument 
          for measuring the perception of stress. It is a reliable and validated measure of the 
          degree to which situations in one's life are appraised as stressful.
        </p>
        <p>
          Scores range from 0-40, with higher scores indicating higher perceived stress. This 
          assessment helps you understand your stress levels and provides personalized recommendations 
      ...
      <div className="disclaimer">
        <AlertCircle size={18} />
        <p>
          <strong>Confidential:</strong> Your responses are private and not shared. 
          This is a self-assessment tool, not a medical diagnosis.
        </p>
      </div>
    </div>
  );

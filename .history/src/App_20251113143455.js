...
import AuroraDashboard from "./pages/premium/AuroraDashboard";
        ...
        <AIWidgetContext.Provider value={aiWidgetRef}>
          <Router>
            ...
            <Routes>
              ...
              <Route path="/admin/users" element={<AdminRoute><UsersAdmin /></Route>} />
              <Route path="/admin/assistants" element={<AdminRoute><AdminAssistants /></Route>} />
              <Route path="/providers/admin/verify" element={<AdminRoute><AdminVerify /></Route>} />
              <Route path="/providers/admin/import" element={<AdminRoute><AdminImport /></Route>} />
              <Route path="/dev-tools" element={<AdminRoute><DevTools /></Route>} />

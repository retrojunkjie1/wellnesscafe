...
const MeditationTimer = () => {
  ...
  const ambientSounds = [
    ...
    },
    {
      ...
      icon: "🌊",
      url: null,
      description: "Rhythmic waves for grounding (Coming Soon)",
      disabled: true,
    },
    {
      id: "forest",
      ...
      icon: "🌲",
      url: null,
      description: "Birds and nature sounds (Coming Soon)",
      disabled: true,
    },
    {
      id: "river",
      ...
      icon: "💧",
      url: null,
      description: "Flowing water for peace (Coming Soon)",
      disabled: true,
    },
    {
      id: "wind",
      ...
      icon: "🎐",
      url: null,
      description: "Gentle chimes for serenity (Coming Soon)",
      disabled: true,
    },
    {
      id: "tibetan",
      ...
      icon: "🔔",
      url: null,
      description: "Sacred singing bowl tones (Coming Soon)",
      disabled: true,
    },
    {
      id: "fire",
      ...
      icon: "🔥",
      url: null,
      description: "Warm fireplace ambiance (Coming Soon)",
      disabled: true,
    },
  ];

...
```
      ...
      {/* Sober Living Homes Directory */}
      <section className="sober-homes-section">
        <h2>🏠 Sober Living Homes & Oxford Houses</h2>
        <p className="sober-homes-intro">
          Find peer-run sober living homes and recovery housing in your state. Our directory includes 
          real-time Oxford House vacancy data updated daily, plus verified recovery residences nationwide.
        </p>
        <div className="sober-homes-features">
          <div className="feature-highlight">
            <span className="feature-icon">✅</span>
            <h4>Real-Time Vacancies</h4>
            <p>Live updates from Oxford House network showing available beds</p>
          </div>
          <div className="feature-highlight">
            <span className="feature-icon">🔍</span>
            <h4>Search by Location</h4>
            <p>Filter by state, city, county, and gender-specific housing</p>
          </div>
          <div className="feature-highlight">
            <span className="feature-icon">📞</span>
            <h4>Direct Contact</h4>
            <p>House phone numbers and manager information for immediate inquiry</p>
          </div>
        </div>
        <div className="state-selector-compact">
          <label htmlFor="sober-homes-state">Select Your State:</label>
          <select 
            id="sober-homes-state"
            onChange={(e) => {
              if (e.target.value) {
                window.location.href = `/resources/soberLivingHomes/${e.target.value}`;
              }
            }}
            defaultValue=""
          >
        ...
        <div className="sober-homes-info">
          <p className="info-note">
            💡 <strong>What are Oxford Houses?</strong> Peer-run, democratic sober living homes with no time limits. 
            Residents share expenses, maintain the house, and support each other's recovery. No staff or paid counselors—
            just peers helping peers stay sober.
          </p>
        </div>
      </section>

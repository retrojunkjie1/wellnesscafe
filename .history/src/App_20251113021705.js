        ...
        <AIWidgetContext.Provider value={aiWidgetRef}>
          <Router>
            ...
            <Routes>
              ...
              <Route path="/providers/dashboard" element={<ProtectedRoute roles={["provider", "admin"]}><ProviderDashboard /></ProtectedRoute>} />
              ...
              <Route path="/admin/assistants" element={<ProtectedRoute roles={["admin"]}><AdminAssistants /></ProtectedRoute>} />
              <Route path="/providers/admin/verify" element={<ProtectedRoute roles={["admin"]}><AdminVerify /></ProtectedRoute>} />
              <Route path="/providers/admin/import" element={<ProtectedRoute roles={["admin", "provider"]}><AdminImport /></ProtectedRoute>} />
              ...
              {/* Dev & Debug Routes */}
              <Route path="/dev-tools" element={<ProtectedRoute roles={["admin"]}><DevTools /></ProtectedRoute>} />

...
// New Route Guards
import ProtectedRoute from "./components/access/ProtectedRoute.js";
import PremiumRoute from "./components/access/PremiumRoute.js";
import ProviderRoute from "./components/access/ProviderRoute.js";
import AdminRoute from "./components/access/AdminRoute.js";
        ...
        <AIWidgetContext.Provider value={aiWidgetRef}>
          <Router>
            ...
            <Routes>
              ...
              <Route path="/tools/gratitude-journal" element={<ProtectedRoute><GratitudeJournalPage /></ProtectedRoute>} />
              <Route path="/tools/meditation-premium" element={<ProtectedRoute><MeditationTimerPremiumPage /></ProtectedRoute>} />
              <Route path="/tools/emotion-tracker" element={<ProtectedRoute><EmotionTrackerPage /></ProtectedRoute>} />
              <Route path="/tools/trigger-journal" element={<ProtectedRoute><TriggerJournalPage /></ProtectedRoute>} />
              <Route path="/tools/weekly-review" element={<ProtectedRoute><WeeklyReviewPage /></ProtectedRoute>} />
              <Route path="/tools/trigger-tracker" element={<ProtectedRoute><TriggerTrackerPage /></ProtectedRoute>} />
              <Route path="/tools/mood-checkin" element={<ProtectedRoute><MoodCheckInPage /></ProtectedRoute>} />

              {/* PREMIUM-PROTECTED ROUTES */}
              <Route path="/aurora" element={<PremiumRoute><AuroraDashboard /></PremiumRoute>} />
              
              {/* PROVIDER-PROTECTED ROUTES */}
              <Route path="/providers/dashboard" element={<ProviderRoute><ProviderDashboard /></ProviderRoute>} />
              ...
              <Route path="/providers/admin/verify" element={<AdminRoute><AdminVerify /></AdminRoute>} />
              <Route path="/providers/admin/import" element={<AdminRoute><AdminImport /></AdminRoute>} />
              <Route path="/dev-tools" element={<AdminRoute><DevTools /></AdminRoute>} />

              {/* Provider Public Routes */}
              <Route path="/providers" element={<ProvidersPage />} />
              <Route path="/providers/apply" element={<ProviderSignup />} />
              <Route path="/providers/directory" element={<ProviderDirectory />} />
              <Route path="/providers/benefits" element={<BenefitsDetail />} />
              <Route path="/providers/expectations" element={<ExpectationsDetail />} />
              <Route path="/providers/testimonials" element={<TestimonialsDetail />} />
              ...
              <Route path="/about/strategic-initiatives" element={<StrategicInitiatives />} />
              ...
              <Route path="/resources/soberLivingHomes/:state" element={<SoberHomesState />} />
